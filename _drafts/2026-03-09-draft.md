---
layout: post
title: "A New CircuitPython IDE, Triaging MicroPython, MicroPython OpenClaw and More!"
...
Welcome to the latest Python on Microcontrollers newsletter! My, what a busy week! As your editor slogs through making VGA video in CircuitPython and RP2350 PIO, the news has come in fast and furious! A new CircuitPython IDE has arrived looking to challenge Mu (which is no longer updated). Folks are looking at the MicroPython Issues and Pull Request backlog with plans to tackle it. And yet another OpenClaw take using MicroPython looks to put an agent in your pocket. It's getting to the point you can code your own LLM/AI, down to making a Python MCP server.
...
[Last Friday](https://youtube.com/live/m879n3APfdQ), Tim stepped in for Scott to talk light sensor drivers and guides.
...
[![Weather forecast](../assets/20260309/20260309frame.jpg)](https://fabscene.com/new/make/raspberry-pi-pico-2w-epaper-weather-station-micropython-waveshare/)

A wall-mounted weather forecast that blends in with your interior, created with e-paper, MicroPython and Raspberry Pi Pico 2W - [FabScene](https://fabscene.com/new/make/raspberry-pi-pico-2w-epaper-weather-station-micropython-waveshare/) and [GitHub](https://github.com/Damov/micropython-ePaperWeatherStation). Via [X](https://x.com/oitamaIoT/status/2028931280893837505).

[![CircuitPython_Nitroclass](../assets/20260309/20260309tek.jpg)](https://github.com/tekktrik/CircuitPython_Nitroclass)

CircuitPython_Nitroclass is a new CircuitPython library to supercharge CircuitPython classes, similar to CPython dataclasses - [GitHub](https://github.com/tekktrik/CircuitPython_Nitroclass). Via [Mastodon](https://mastodon.social/@tekktrik@techhub.social/116171335483406052).
...
[![These 3 Pimoroni Badges are INCREDIBLE!](../assets/20260309/20260309badge.jpg)](https://www.youtube.com/live/L4bFDYHUAy0)

These 3 Pimoroni badges are INCREDIBLE! Using the Blinky 2350, Tufty 2350 and the classic Badger 2350 with MicroPython - [YouTube](https://www.youtube.com/live/L4bFDYHUAy0).
...
[![Air Quality sensor version 3](../assets/20260309/20260309air.jpg)](https://mastodon.social/@hiltsu/116164436880977916)

Air Quality sensor version 3 is now tested and working. It has a 3D printed case. The device sends data to the database using IoT/MQTT and shows on a display. Coded in MicroPython on an ESP32 - [Mastodon](https://mastodon.social/@hiltsu/116164436880977916) and [Codeberg](https://codeberg.org/hiltsu/micropython-for-embedded-systems/src/branch/main/Airquality/esp32-oled-mhz19b-pms9103m-bme680/readme.md) (Finnish).

[![Recording DV over FireWire on a Raspberry Pi 5](../assets/20260309/20260309fire.jpg)](https://bsky.app/profile/jeffgeerling.com/post/3mg6uxz3grk2r)

Sneak peek of recording DV over FireWire on a Raspberry Pi 5, via the prototype Firehat - [BlueSky](https://bsky.app/profile/jeffgeerling.com/post/3mg6uxz3grk2r).

[![Raspberry Pi CM0](../assets/20260309/20260309cm0.jpg)](https://bret.dk/raspberry-pi-cm0-edatec-cm0nano/)

What is the Raspberry Pi CM0? And.. why? - [bret.dk](https://bret.dk/raspberry-pi-cm0-edatec-cm0nano/).
...
[![39,098 THANKS](../assets/20260309/39kdiscord.jpg)](https://adafru.it/discord)
