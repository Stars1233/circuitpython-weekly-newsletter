...
bobricius shows a fabulous WIP project, the PiComputer Flip DVI runs CircuitPython and CircuitPython OS and has HDMI, Raspberry Pi Pico 2(W), a 2.8" IPS LCD, SD card, speaker, 3.5 audio with speaker switch, a Hall Effect sensor to turn off the display, perhaps retro emulation, and USB Host - [X](https://x.com/bobricius/status/2028508304167575688).
