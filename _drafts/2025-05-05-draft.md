---
layout: post
title: "CircuitPython Improvements, Raspberry Pi Quality, PyXL and Much More!"
...
Welcome to the latest Python on Microcontrollers newsletter! With warm weather comes a cornucopia of events, so check the events section this issue. A number of improvements to CircuitPython are arriving with increases in speed and capabilities. People are finally getting their hands on the Espressif ESP32-P4, but tariffs may impede their arrival worldwide. All that and so much more in this jam-packed issue. Thank you for subscribing. - *Anne Barela, Editor*
...
[![CircuitPython 10.0.0-alpha.3](../assets/20250505/20250505cp10.jpg)](https://github.com/adafruit/circuitpython/releases/tag/10.0.0-alpha.3)

CircuitPython 10.0.0-alpha.3, an alpha release for 10.0.0, is now out. Further features, changes, and bug fixes will be added before the final release of 10.0.0 - [GitHub](https://github.com/adafruit/circuitpython/releases/tag/10.0.0-alpha.3). *Note: On [last week's Ask an Engineer broadcast](https://www.youtube.com/live/YUlqX8jo7K0?feature=shared&t=3787), it was shared the CircuitPython 10 poster may take inspiration from the graphic above. Your editor has made this version prior to the final art selection.*
...
[![MicroPython Comes to the PicoCalc Calculator](../assets/20250505/20250505pc.jpg)](https://github.com/LofiFren/PicoCalc)

Lofi Fren has ported MicroPython to the PicoCalc, a Raspberry Pi Pico 2 W device we had in the March 17th newsletter - [GitHub](https://github.com/LofiFren/PicoCalc).

A synthesizer using MicroPython and PicoCalc has also been developed - [YouTube](https://www.youtube.com/watch?v=pktBirYcHD0) and [GitHub](https://github.com/LofiFren/PicoCalc/blob/main/MicroPython/sd/py_scripts/synth.py).
...
[![Deep Dive](../assets/20250505/20250505deepdive.jpg)](https://youtube.com/live/gkBYOGRCp0M)

[Last Friday](https://youtube.com/live/gkBYOGRCp0M), Tim streamed work on the Fruit Jam Launcher and Editor.

You can see the latest video and past videos on the Adafruit YouTube channel under the Deep Dive playlist - [YouTube](https://www.youtube.com/playlist?list=PLjF7R1fz_OOXBHlu9msoXq2jQN4JpCk8A).

**CircuitPython Parsec**

[![CircuitPython Parsec](../assets/20250505/20250505jp.jpg)](https://blog.adafruit.com/2025/05/02/john-parks-circuitpython-parsec-seesaw-scroll-wheel/)

John Park’s CircuitPython Parsec this week is on a Seesaw Scroll Wheel - [Adafruit Blog](https://blog.adafruit.com/2025/05/02/john-parks-circuitpython-parsec-seesaw-scroll-wheel/) and [YouTube](https://youtu.be/wBUQBSuY6BM).
...
[![Synthio Tutorial: Audio Effects](../assets/20250505/20250505tod.jpg)](https://todbot.github.io/CircuitPython_Synthio_Tutorial/#sections)

Tod Kurt has been documenting how to use the CircuitPython `synthio` module. The lattest edition is on [Audio Effects](https://todbot.github.io/CircuitPython_Synthio_Tutorial/README-6-Audio-Effects.html) - [GitHub](https://todbot.github.io/CircuitPython_Synthio_Tutorial/#sections).
...
[![Microcontrollers and Machine Learning with MicroPython and emlearn](../assets/20250505/20250505foss.jpg)](https://www.youtube.com/watch?v=hi1lHsLZzqk)

FOSS North 2025 talk: Microcontrollers and Machine Learning with MicroPython and emlearn - [YouTube](https://www.youtube.com/watch?v=hi1lHsLZzqk).
...
[![I2C and SPI protocols](../assets/20250505/20250505rare.jpg)](https://blog.rareschool.com/)

Romilly Cocking is restarting a series of blog posts about using I2C and SPI protocols with devices like the Raspberry Pi, the Pico and Jetson Nano - [RAREblog](https://blog.rareschool.com/).

[![Lower prices for 4GB and 8GB Compute Module 4](../assets/20250505/20250505cm4.jpg)](https://www.raspberrypi.com/news/lower-prices-for-4gb-and-8gb-compute-module-4/)

Lower prices for 4GB and 8GB Raspberry Pi Compute Module 4 - [Raspberry Pi News](https://www.raspberrypi.com/news/lower-prices-for-4gb-and-8gb-compute-module-4/).

[![MicroPython v.1.26.0 Milestone](../assets/20250505/20250505mp6.jpg)](https://github.com/micropython/micropython/milestone/10)

On the heels of MicroPython v1.25.0 being released is news of the v1.26.0 milestone, targeted for July 31st. If you want to keep track, you can follow progress (or help) on [GitHub](https://github.com/micropython/micropython/milestone/10).

[![CircuitPython based synthesizer](../assets/20250505/20250505synth.jpg)](https://v.basspistol.org/w/qmjJ3TY8Q8mEzigVywDXmt)

A CircuitPython based synthesizer - [Mastodon](https://v.basspistol.org/w/qmjJ3TY8Q8mEzigVywDXmt).

[![AccessiPong](../assets/20250505/20250505pong.jpg)](https://www.instructables.com/Accessible-Pong-Game-AccessiPong/)

Accessible Pong Game (AccessiPong) with Adafruit MatrixPortal M4 and CircuitPython - [Instructables](https://www.instructables.com/Accessible-Pong-Game-AccessiPong/) and [YouTube](https://www.youtube.com/watch?v=8pRfARhBrQw).

[![Using larger displays](../assets/20250505/20250505lvgl.jpg)](https://www.youtube.com/watch?v=aWSe20mg_j0)

Raspberry Pi Pico and MicroPython LVGL - using larger displays - [YouTube](https://www.youtube.com/watch?v=aWSe20mg_j0).

[![Heat Seeking Beverage Bot](../assets/20250505/20250505bot.jpg)](https://www.instructables.com/Heat-Seeking-Beverage-Bot/)

A heat seeking beverage bot using a Roomba, Raspberry Pi Pico W, and Adafruit AMG8833 thermal sensor with CircuitPython and Adafruit IO - [Instructables](https://www.instructables.com/Heat-Seeking-Beverage-Bot/) and [YouTube](https://www.youtube.com/watch?v=sHaQSFladFs).

[![Pi Digital Clock 7.84 Inch (PYTHON)](../assets/20250505/20250505yak.jpg)](https://www.instructables.com/Pi-Digital-Clock-784-Inch-PYTHON/)

A Raspberry Pi digital clock with a long LCD display using Python - [Instructables](https://www.instructables.com/Pi-Digital-Clock-784-Inch-PYTHON/) and [YouTube](https://youtu.be/NazJjIEi6-8).
...
[![Learn Guides](../assets/20250505/20250505learn.jpg)](https://learn.adafruit.com/guides/latest)
...
Here's this week's new CircuitPython libraries:
  ...
  * [circuitpython/CircuitPython_Org_DisplayIO_Cartesian](https://github.com/circuitpython/CircuitPython_Org_DisplayIO_Cartesian)
  * [circuitpython/CircuitPython_Org_DisplayIO_Dial](https://github.com/circuitpython/CircuitPython_Org_DisplayIO_Dial)
...
CircuitPython's stable release is [9.2.7](https://github.com/adafruit/circuitpython/releases/latest) and its unstable release is [10.0.0-alpha.3](https://github.com/adafruit/circuitpython/releases). New to CircuitPython? Start with our [Welcome to CircuitPython Guide](https://learn.adafruit.com/welcome-to-circuitpython).

[20250501](https://github.com/adafruit/Adafruit_CircuitPython_Bundle/releases/latest) is the latest Adafruit CircuitPython library bundle.

[20250502](https://github.com/adafruit/CircuitPython_Community_Bundle/releases/latest) is the latest CircuitPython Community library bundle.
...
[3.13.3](https://www.python.org/downloads/) is the latest Python release. The latest pre-release version is [3.14.0a7](https://www.python.org/download/pre-releases/).

[4,259 Stars](https://github.com/adafruit/circuitpython/stargazers) Like CircuitPython? [Star it on GitHub!](https://github.com/adafruit/circuitpython)
