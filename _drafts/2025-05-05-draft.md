...
Welcome to the latest Python on Microcontrollers newsletter! With warm weather comes a cornucopia of events, so check the events section this issue. A number of improvements to CircuitPython are arriving in terms of speed and capabilities. People are getting their hands on the Espressif ESP32-P4 but tariffs may impede their arrival worldwide. All that and so much more in this jam-packed issue. Thank you for subscribing. - *Anne Barela, Editor*
