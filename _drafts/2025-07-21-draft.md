...
Welcome to the latest Python on Microcontrollers newsletter! Coming off the shock that someone has invented the Chicago-style hot dog pizza (in a city of much better pizza), I've yet again collected a collection of Python information to tempt the senses. The first beta of CircuitPython 10 is locking in the features for this major update. I was looking to do some DVI video with the RP2350 but the information was fragmented. It's now centralized in my new Adafruit Learning System guide. When should you use a Raspberry Pi vs. a microcontroller, find out that and much more in this SUmmer reading edition - *Anne Barela, Editor*
...
Have you ever visually wanted to see or manipulate the GPIO on your Raspberry Pi devices? pigg is set of apps for Raspberry Pi GPIO output control and input visualization, with GUI and CLI Support for macOS, Linux (including Raspberry Pi) and Windows. It has a GPIO CLI agent for Raspberry Pi and embedded applications for Pi Pico (USB) and Pi Pico W (USB, TCP) - [GitHub](https://github.com/andrewdavidmackenzie/pigg?tab=readme-ov-file).
