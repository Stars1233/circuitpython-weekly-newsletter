---
layout: post
title: "New CircuitPython Release Candidate, Linux 7, Pi OS Update and More!"
...
Welcome to the latest Python on Microcontrollers newsletter. Software abounds! Everyone has been excited about the new version of MicroPython being released. And it's in time for MicroPython's 13th birthday we'll be celebrating in the next newsletter. CircuitPython is getting a new release soon, you can kick the tires now. The Linux kernel has ticked over to a najor update and as soon as Debian has it I'll bet the Raspberry Pi OS folks will incorporate it. Pi OS was updated for a default password required for sudo. Security these days...
...
[![Multithreading (and use in MicroPython)](../assets/20260420/20260420mt.jpg)](https://dev.to/quecpython/multithreading-2lll)

Multithreading is a technique that allows multiple threads to execute concurrently in software or hardware. In a program, multiple threads can execute simultaneously, each performing independent tasks. Check out this article and MicroPython applicability - [dev.to](https://dev.to/quecpython/multithreading-2lll). Via [BlueSky](https://bsky.app/profile/functionalprogramming.activitypub.awakari.com.ap.brid.gy/post/3mjomdyte4li2).
...
[![Tetris](../assets/20260420/20260420tet.gif)](https://mastodon.social/@blitzcitydiy/116416821556683314)

New project in progress - a CircuitPython-powered NeoPixel Tetris controlled by a seesaw gamepad - [Mastodon](https://mastodon.social/@blitzcitydiy/116416821556683314).

[![Accessible Catch Game for people with severe Physical Challenges](../assets/20260420/20260420ghost.jpg)](https://github.com/gallaugher/accessible-catch-with-hub75-displays)

An accessible catch game for people with severe physical challenges, coded in CircuitPython - [YouTube](https://www.youtube.com/watch?v=98N8J6Ri4L4) and [GitHub](https://github.com/gallaugher/accessible-catch-with-hub75-displays). Via [Mastodon](https://mastodon.social/@gallaugher@mastodon.world/116387212485589390).

[![Bus servo](../assets/20260420/20260420kev.jpg)](https://mastodon.social/@kevsmac/116393649913315426)

Kevin McAleer is using MicroPython for some bus servo stuff for robotic arms - [Mastodon](https://mastodon.social/@kevsmac/116393649913315426).
