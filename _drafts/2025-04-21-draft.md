...
"Checking the LoRa transmission (MicroPython version, the lib is micropySX126X) for the Seeed Studio Wio-SX1262 using the FlippeZero. Now it's time to see if  CircuitPython also works, and also to setup a receiver, then test the range" - [X](https://x.com/CosminDolha/status/1912821905007968438).
