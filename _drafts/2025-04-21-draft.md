---
layout: post
title: "MicroPython v1.25 is Out, Arduino Editor with AI Assist, Free Books and more!"
...
[![Arduino AI Assistant](../assets/20250421/20250421cloud.jpg)](https://blog.arduino.cc/2025/04/17/code-faster-with-the-new-arduino-ai-assistant/)
...
Ubuntu 25.04 is the latest version of the Ubuntu operating system for desktop PCs and laptops  - [Ubuntu](https://ubuntu.com/download/desktop) and [Release Notes](https://discourse.ubuntu.com/t/plucky-puffin-release-notes/48687) and [Tom's Hardware](https://www.tomshardware.com/software/linux/ubuntu-25-04-launches-with-host-of-new-features). Via [X](https://x.com/omgubuntu/status/1912795977959752148).
...
[![Deep Dive](../assets/20250421/20250421deepdivet.jpg)](https://youtube.com/live/YSB2QMw2fuY)

[Last Friday](https://youtube.com/live/YSB2QMw2fuY), Tim streamed work on a Fruit Jam OS Launcher.

You can see the latest video and past videos on the Adafruit YouTube channel under the Deep Dive playlist - [YouTube](https://www.youtube.com/playlist?list=PLjF7R1fz_OOXBHlu9msoXq2jQN4JpCk8A).

**CircuitPython Parsec**

[![CircuitPython Parsec](../assets/20250421/20250421jp.jpg)](https://blog.adafruit.com/2025/04/18/john-parks-circuitpython-parsec-bme280-sensor-on-feather-esp32-s2/)

John Park’s CircuitPython Parsec this week is on using a BME280 Sensor with a Feather ESP32-S2 - [Adafruit Blog](https://blog.adafruit.com/2025/04/18/john-parks-circuitpython-parsec-bme280-sensor-on-feather-esp32-s2/) and [YouTube](https://youtu.be/17XbqSpTHlE).
...
[![USB MIDI Korg](../assets/20250421/20250421korg.jpg)](https://x.com/Synclon/status/1913177040473530757)

The USB MIDI packets of the KORG nano series are irregular. Although it should be a 4-byte packet, the 4-byte MIDI message is placed at the beginning of a 64-byte packet. This person used a Raspberry Pi Pico and CircuitPython to tweak the MIDI to a format a digital audio workstation (DAW) would recognize - [X](https://x.com/Synclon/status/1913177040473530757).

[![Record Player](../assets/20250421/20250421record.gif)](https://www.instructables.com/Record-Player-a-Real-Player-That-Plays-Fake-Record/)

Record Player is a music player that plays physical records with Raspberry Pi and an Adafruit QT Py programmed with CircuitPython - [Instructables](https://www.instructables.com/Record-Player-a-Real-Player-That-Plays-Fake-Record/), [YouTube](https://www.youtube.com/watch?v=qOQR8iDCI8Y) and [GitHub](https://github.com/lennyomg/recordplayer/).

[![LoRa transmission](../assets/20250421/20250421flipper.gif)](https://x.com/CosminDolha/status/1912821905007968438)

"Checking the LoRa transmission (MicroPython version, the lib is micropySX126X) for the Seeed Studio Wio-SX1262 using the FlippeZero. Now it's time to see if  CircuitPython also works and to setup a receiver to test the range" - [X](https://x.com/CosminDolha/status/1912821905007968438).
...
[![Pip-Boy 2040](../assets/20250421/20250421pip.jpg)](https://manchicken.com/2025/03/08/pip-boy-2040-finished/)

A lovely red build of the [Pip-Boy RP2040](https://learn.adafruit.com/pip-boy-2040/overview) running CircuitPython - [manchicken.com](https://manchicken.com/2025/03/08/pip-boy-2040-finished/).

[![MP4 Player](../assets/20250421/20250421mp4.jpg)](https://www.youtube.com/shorts/BUj7DpVeqVk)

An MP4 video player using a Raspberry Pi Zero W, an LCD screen and CircuitPython. This person used a Raspberry Pi Pico running CircuitPython to  - [YouTube](https://www.youtube.com/shorts/BUj7DpVeqVk).

[![Reverse geolocator](../assets/20250421/20250421geo.jpg)](https://www.hackster.io/Shilleh/create-a-reverse-geolocator-with-pico-w-and-gps-module-5d6d66)

A reverse geolocator with a Raspberry Pi Pico W, MicroPython and GPS Module - [hackster.io](https://www.hackster.io/Shilleh/create-a-reverse-geolocator-with-pico-w-and-gps-module-5d6d66).
...
[![MicroPython Machine Light/Deep Sleep, Idle and Frequency](../assets/20250421/20250421sleep.jpg)](https://www.youtube.com/watch?v=irOu9VSDdY4)

MicroPython machine light/deep sleep, idle and frequency - [YouTube](https://www.youtube.com/watch?v=irOu9VSDdY4).

[![LE heart rate monitor](../assets/20250421/20250421heart.jpg)](https://x.com/neuropticAIag/status/1912376031484260761)

CircuitPython BLE heart rate monitoring on an Adafruit Clue nRF52840 microcontroller - [X](https://x.com/neuropticAIag/status/1912376031484260761l).
...
[![Converting Dijkstra's Algorithm from Python3 to CircuitPython](../assets/20250421/20250421convert.jpg)](https://www.youtube.com/watch?v=0knqvJzWIXg)

Converting Dijkstra's Algorithm from Python3 to CircuitPython - [YouTube](https://www.youtube.com/watch?v=0knqvJzWIXg).

[![Raspberry Pi cluster spotted inside $6k audio processor](../assets/20250421/20250421cluster.jpg)](https://www.jeffgeerling.com/blog/2025/raspberry-pi-cluster-spotted-inside-6k-audio-processor)

Raspberry Pi cluster spotted inside $6k audio processor - [Jeff Geerling](https://www.jeffgeerling.com/blog/2025/raspberry-pi-cluster-spotted-inside-6k-audio-processor).
...
Here's this week's new CircuitPython libraries:
  ...
  * [adafruit/Adafruit_CircuitPython_Anchored_Group](https://github.com/adafruit/Adafruit_CircuitPython_Anchored_Group)
...
CircuitPython's stable release is [9.2.7](https://github.com/adafruit/circuitpython/releases/latest) and its unstable release is [10.0.0-alpha.2](https://github.com/adafruit/circuitpython/releases). New to CircuitPython? Start with our [Welcome to CircuitPython Guide](https://learn.adafruit.com/welcome-to-circuitpython).

[20250415](https://github.com/adafruit/Adafruit_CircuitPython_Bundle/releases/latest) is the latest Adafruit CircuitPython library bundle.

[20250418](https://github.com/adafruit/CircuitPython_Community_Bundle/releases/latest) is the latest CircuitPython Community library bundle.
...
[4,247 Stars](https://github.com/adafruit/circuitpython/stargazers) Like CircuitPython? [Star it on GitHub!](https://github.com/adafruit/circuitpython)
...
[![38,919 THANKS](../assets/20250421/38kdiscord.jpg)](https://adafru.it/discord)

[![Adafruit Discord](https://discordapp.com/api/guilds/327254708534116352/embed.png?style=banner3)](https://discord.gg/adafruit)

The Adafruit Discord community, where we do all our CircuitPython development in the open, reached over 38,919 humans - thank you! Adafruit believes Discord offers a unique way for Python on hardware folks to connect. Join today at [https://adafru.it/discord](https://adafru.it/discord).
