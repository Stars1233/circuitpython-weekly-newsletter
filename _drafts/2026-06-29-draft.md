...
Welcome to the latest Python on Microcontrollers newsletter! I'm sending my coolest hopes to Europe as they battle the current heat wave. I remember the [summer of 2015](https://weatherspark.com/h/y/61302/2015/Historical-Weather-during-2015-in-Frankfurt-am-Main-Hesse-Germany) as a scorcher in Frankfurt. This issue there are two featues on security: first a Visual Studio Code plug-in to catch security issues on dependencies. And OpenAI is trying to help open source folks with security (good, as open source is the backbone of code). A new alpha version of CircuitPython adds  some USB Audio goodies long sought by the community. And the Raspberry Pi sagas continue with discounts for clock limited versions and the venerible Rpilocator.com site is shutting down as stores limit access to their sites. Despite all of the hubub, Pi projects continue to be built in good numbers attested by this week's projects. Stay cool, my friends. - *Anne Barela, Editor*
