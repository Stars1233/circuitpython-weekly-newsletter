---
layout: post
title: "Original Pi Heading Towards EOL, CircuitPython MIPI DSI, LLM Robots and More!"
...
Welcome to the latest Python on Microcontrollers newsletter! Most of us have been exposed to hardware and software obsolescence. And we're familiar with the Raspberry Pi's introduction in 2012, a long time ago by oproduct standards. Linix, in it's quest to shed architectures that are not widely used, lis looking to drop support for the BCM2385 processor. All is not lost, it's likely not to be fully implemented until the end of the decade. Better than [internet juicers](https://en.wikipedia.org/wiki/Juicero). CircuitPython is looking to expand into support for MIPI DSI displays used on larger panels. Raspberry Pi is extending their $20,000 challenge to hack their AES implementation through the end of the year. All of this and much more in this mega issue. - *Anne Barela, Editor*
...
## MIT Researchers Propose a New Model for Legible, Modular Software Rather Than Using Just AI
...
## Making a Locally Hosted Conversational Skeleton

[![Conversational, Locally Hosted, Talking Skeleton Companion](../assets/20251110/20251110proto.jpg)](https://www.instructables.com/Conversational-Locally-Hosted-Talking-Skeleton-Com/)

Timmy the skeleton has been turned by Instructables user gearscodeandfire into a conversational companion. Built using Raspberry Pi and several Python packages - [Instructables](https://www.instructables.com/Conversational-Locally-Hosted-Talking-Skeleton-Com/) and [YouTube](https://youtu.be/Qa2pS0ToKvQ).

> "He is entirely locally run for privacy. He has real-time text-to-speech and speech-to-text, semantic and episodic memory, vision, and thinks pretty darn well for a lightweight model. For debugging, I got webRTC running on him so friends can telepresence into Little Timmy, look around, and type what he says. He sounds like Skeletor, and his job is to make fun of me like a resentful cohost."
...
[![CircuitPython Parsec](../assets/20251110/20251110jp.jpg)](https://blog.adafruit.com/2025/11/07/john-parks-circuitpython-parsec-spyce-invaders-reset-from-controller/)

John Park’s CircuitPython Parsec this week is on Spyce Invaders Reset from Controller - [Adafruit Blog](https://blog.adafruit.com/2025/11/07/john-parks-circuitpython-parsec-spyce-invaders-reset-from-controller/) and [YouTube](https://youtu.be/qTLPyZ35j7A).
...
[![Interactive dog skull](../assets/20251110/20251110dog.jpg)](https://www.instructables.com/Interactive-Dog-Skull-Prototype/)

An interactive dog skull prototype with Adafruit Circuit Playground Express and CircuitPython - [Instructables](https://www.instructables.com/Interactive-Dog-Skull-Prototype/) and [YouTube](https://www.youtube.com/watch?v=yc-2dp7tuYk).
...
Another hack of the GitHub Universe 2025 badge to display GitHub statistics with MicroPython - [X](https://x.com/iAnonymous3000/status/1986104933528060093).

[![Programming hardware displays the easy way - using MicroPython and LVGL — Marc-André Lemburg](../assets/20251110/20251110eur.jpg)](https://www.youtube.com/watch?v=VBW25a1AbSI)

PEuroPython talk: Programming hardware displays the easy way - using MicroPython and LVGL — Marc-André Lemburg - [YouTube](https://www.youtube.com/watch?v=VBW25a1AbSI). Via [X](https://x.com/malemburg/status/1985726774068805830).

[![15 Cool Project Ideas for the Little Raspberry Pi Zero](../assets/20251110/20251110proj.jpg)](https://raspberrytips.fr/projets-rasbperry-pi-zero/)

15 cool project ideas for the little Raspberry Pi Zero - [RaspberryTips.fr](https://raspberrytips.fr/projets-rasbperry-pi-zero/) (French).

[![9 Things I Wish I Knew Before Buying My First Raspberry Pi](../assets/20251110/20251110first.jpg)](https://raspberrytips.com/things-to-know-before-buying-pi/)

9 things I wish I knew before buying my first Raspberry Pi - [Raspberry Tips](https://raspberrytips.com/things-to-know-before-buying-pi/).

[![Pi-Apps in Raspberry OS with KDE](../assets/20251110/20251110install.jpg)](https://lucstechblog.blogspot.com/2025/11/pi-apps-in-raspberry-os-with-kde.html)

Using Pi-Apps in Raspberry OS with KDE for installing new apps - [lucstechblog](https://lucstechblog.blogspot.com/2025/11/pi-apps-in-raspberry-os-with-kde.html).

[![Adding a Touch Button to GurgleApps Word Clock Using RP2040/RP2350 Programmable IO (PIO)](../assets/20251110/20251110gawordclockcaptouch550.jpg)](https://www.instructables.com/Add-Touch-Button-to-GurgleApps-Word-Clock-Using-RP/)
...
This week there were no new boards added but 5 are in process.
...
Here are this week's new CircuitPython libraries:
  ...
  * [bikeNomad/CircuitPython_grove_vision_ai_v2](https://github.com/bikeNomad/CircuitPython_grove_vision_ai_v2)

**Updated Libraries**

Here are this week's updated CircuitPython libraries:

  * [adafruit/Adafruit_CircuitPython_ATECC](https://github.com/adafruit/Adafruit_CircuitPython_ATECC)
...
[20251105](https://github.com/adafruit/Adafruit_CircuitPython_Bundle/releases/latest) is the latest Adafruit CircuitPython library bundle.
...
[4,377 Stars](https://github.com/adafruit/circuitpython/stargazers) Like CircuitPython? [Star it on GitHub!](https://github.com/adafruit/circuitpython)
...
[![39,040 THANKS](../assets/20251110/39kdiscord.jpg)](https://adafru.it/discord)
