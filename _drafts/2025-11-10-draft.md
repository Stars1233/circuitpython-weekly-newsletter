...
Making a "telephone" built with a voicemodem and an RP2040 MacroPad from Adafruit. It can dial, and listen to calls, adjust volume, and detect when the line is in use or disconnected, pick up inbound calls, and parse caller id. The code in CircuitPython - [YouTube](https://www.youtube.com/watch?v=T_9wwEUem8U).
