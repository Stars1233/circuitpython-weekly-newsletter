---
layout: post
title: "New Python Versions, Now PCBs Are Getting Scarce, BeagleBoard and More!"
...
[![New Python Versions](../assets/20260511/20260511python.jpg)](https://blog.python.org/2026/05/python-3150-beta-1/)

Two new versions of Python were released this week. Python 3.15 gets closer to release while Python 3.14.5 is a release candidate for the fifth maintenance release of 3.14, containing around 113 bugfixes, build improvements and documentation changes since 3.14.4 - [Python 3.15](https://blog.python.org/2026/05/python-3150-beta-1/) and [Python 3.14](https://blog.python.org/2026/05/python-3145rc1/).

The best new features of Python 3.15 - [InfoWorld](https://www.infoworld.com/article/4166693/the-best-new-features-in-python-3-15.html).

## You’ve Seen The Chip Shortage And The Memory Shortage, Now Prepare For The PCB Shortage

[![You’ve Seen The Chip Shortage And The Memory Shortage, Now Prepare For The PCB Shortage](../assets/20260511/20260511pcb.jpg)](https://www.reuters.com/world/middle-east/iran-war-disrupts-the-circuit-board-supply-chain-raises-costs-tech-firms-2026-04-27/)

The conflict in the Middle East has disrupted supplies of crucial raw materials and ‌pushed up prices of the printed circuit boards (PCB) used in almost all electronic devices, from smartphones and computers to AI servers, industry sources and executives have said - [Reuters](https://www.reuters.com/world/middle-east/iran-war-disrupts-the-circuit-board-supply-chain-raises-costs-tech-firms-2026-04-27/). Via [Hackaday](https://hackaday.com/2026/05/06/youve-seen-the-chip-shortage-and-the-memory-shortage-now-prepare-for-the-pcb-shortage/).
...
[![OpenAI Codex Features on a Real Python Codebase](../assets/20260511/20260511codex.jpg)](https://thenewstack.io/openai-codex-claude-code/)

OpenAI has updated Codex with computer use, an in-app browser, and PR reviews. Testing on HTTPie revealed how these features handle real-world Python bug fixes - [The New Stack](https://thenewstack.io/openai-codex-claude-code/).
...
[![Deep Dive](../assets/20260511/20260511deepdive.jpg)](https://youtube.com/live/mMIY6kds0XM)

[Last Friday](https://youtube.com/live/mMIY6kds0XM), Scott streamed work on finishing P4HIL.

You can see the latest video and past videos on the Adafruit YouTube channel under the Deep Dive playlist - [YouTube](https://www.youtube.com/playlist?list=PLjF7R1fz_OOXBHlu9msoXq2jQN4JpCk8A).

**CircuitPython Parsec**

[![CircuitPython Parsec](../assets/20260511/20260511jp.jpg)](https://blog.adafruit.com/2026/05/08/john-parks-circuitpython-parsec-rgb-lcd-character-display-sheild-basics/)

John Park’s CircuitPython Parsec this week is on RGB LCD Character Display Shield Basics - [Adafruit Blog](https://blog.adafruit.com/2026/05/08/john-parks-circuitpython-parsec-rgb-lcd-character-display-sheild-basics/) and [YouTube](https://youtu.be/tuGY2IEebUA?si=fHg91IEKiNJFdWFK).

Catch all the episodes in the [YouTube playlist](https://www.youtube.com/playlist?list=PLjF7R1fz_OOWFqZfqW9jlvQSIUmwn9lWr).

**Deep Dive with Tim**

[![Deep Dive with Tim](../assets/20260511/20260511timdive.jpg)](https://youtube.com/live/x7MCyD-Ge3Q)

[Last week](https://youtube.com/live/x7MCyD-Ge3Q), Tim streamed work on Sensor Locked Secrets Project Code Refactor & Cleanup.
...
[![Popular Last Week](../assets/20260511/20260511last.gif)](https://www.wired.com/story/cyberdecks-tiktok-ube-boobey-diy-computer-gadget/)

What was the most popular, most clicked link, in [last week's newsletter](https://www.adafruitdaily.com/2026/05/04/python-on-microcontrollers-newsletter-cyberdecks-are-hot-anti-ai-gadgets-raspi-cm0s-on-aliexpress-and-more/)? [The Hottest Anti-AI Gadget Is a Cyberdeck](https://www.wired.com/story/cyberdecks-tiktok-ube-boobey-diy-computer-gadget/).

Did you know you can read past issues of this newsletter in the Adafruit Daily Archive? [Check it out](https://www.adafruitdaily.com/category/circuitpython/).

## News From Around the Web

[![THREEPIO](../assets/20260511/20260511three.jpg)](https://hackaday.com/2026/05/02/building-a-c-3po-you-can-really-talk-to/)

Samuel Potozkin has created a real-time, AI-powered conversational droid that you can actually talk to. This project explores what happens when AI is removed from the screen and placed into a physical object—shifting interaction from typing to conversation. Uses a Raspberry Pi 5 and Python - [Hackaday](https://hackaday.com/2026/05/02/building-a-c-3po-you-can-really-talk-to/), [YouTube](https://youtu.be/wB2CJm4sHcM?si=E2H2GeYa8in5wW8g) and [GitHub](https://github.com/spotozkin/threepio).
...
[![PulseTrain](../assets/20260511/20260511pt.jpg)](https://blog.adafruit.com/2026/05/05/creating-specific-pulse-trains-using-an-rp2040-pio-and-circuitpython/)
...
[![Laptop keyboard on your phone](../assets/20260511/20260511kf.jpg)](https://github.com/urfdvw/keyboard-forward)

Need to use your laptop keyboard on your phone? This CircuitPython project forwards laptop keystrokes via a microcontroller over BLE HID, turning your computer into a wireless keyboard - [GitHub](https://github.com/urfdvw/keyboard-forward). Via [X](https://x.com/River___Wang/status/2051492890610635163).
...
[![FPGA Development Kit](../assets/20260511/20260511fpga.jpg)](https://store.tinytapeout.com/products/FPGA-Development-Kit-p813805747)

FPGA Development Kit has a Lattice UP5K FPGA on a PCB with headers and a pinout compatible with the Tiny Tapeout demoboard, which includes all the digital I/O as well as the project reset and clock. It can let you try out and test your digital designs in the same way as you’ll be interacting with ASIC projects: on top of the demoboard, through PMOD headers or the RP2 MicroPython SDK - [Tiny Tapeout](https://store.tinytapeout.com/products/FPGA-Development-Kit-p813805747) and [Demo code](https://fpga.vga-playground.pages.dev/).

[![rp2040js](../assets/20260511/20260511wokwi.jpg)](https://blog.adafruit.com/2026/05/05/rp2040js-is-a-raspberry-pi-pico-emulator-for-the-wokwi-simulation-platform-which-runs-circuitpython-arduino-and-micropython/)

rp2040js is a Raspberry Pi Pico Emulator for the Wokwi Simulation Platform which runs CircuitPython, Arduino and MicroPython - [Adafruit Blog](https://blog.adafruit.com/2026/05/05/rp2040js-is-a-raspberry-pi-pico-emulator-for-the-wokwi-simulation-platform-which-runs-circuitpython-arduino-and-micropython/) and [GitHub](https://github.com/wokwi/rp2040js). Via [Hackaday](https://hackaday.io/project/177082-raspberry-pi-pico-emulator).

[![How to Re-initialize a Stuck ESP32 in CircuitPython](../assets/20260511/20260511stuck.jpg)](https://shallowsky.com/blog/hardware/esp32-reconnect.html)

How to Re-initialize a Stuck ESP32 in CircuitPython - [shallowsky.com](https://shallowsky.com/blog/hardware/esp32-reconnect.html).

[![An accessible driving game](../assets/20260511/20260511drive.jpg)](https://www.instructables.com/Accessible-Driving-Game-With-Haptic-Feedback-Sound/)

An accessible driving game With haptic feedback + sounds with Raspberry Pi Pico 2W and CircuitPython - [Instructables](https://www.instructables.com/Accessible-Driving-Game-With-Haptic-Feedback-Sound/). Via [Mastodon](https://mastodon.social/@gallaugher@mastodon.world/116487655805191091).

[![mcujs](../assets/20260511/20260511js.jpg)](https://github.com/mcu-js/mcujs)

mcujs - a JavaScript runtime for RP2040 and RP2350 microcontrollers, in the same spirit as Node.js for servers - [GitHub](https://github.com/mcu-js/mcujs).

[![Your smart home needs both an ESP32 and Raspberry Pi 5, not one or the other](../assets/20260511/20260511both.jpg)](https://www.xda-developers.com/your-smart-home-needs-an-esp32-and-raspberry-pi/)

Your smart home needs both an ESP32 and Raspberry Pi 5, not one or the other - [XDA](https://www.xda-developers.com/your-smart-home-needs-an-esp32-and-raspberry-pi/).

[![What I learned using Claude Sonnet to migrate Python to Rust](../assets/20260511/20260511rust.jpg)](https://www.infoworld.com/article/4135218/what-i-learned-using-claude-sonnet-to-migrate-python-to-rust.html)
...
Arduino Modulino - intelligent I2C modules used with MicroPython and the Arduino IDE - [YouTube](https://www.youtube.com/watch?v=jlwkmkbAoRA).

[![A music player with the look of the classic PC player WinAmp](../assets/20260511/20260511yak.jpg)](https://x.com/Yakroo5077/status/2051631181746356693)

A music player with the look of the classic PC player WinAmp made with an ESP32-S3 and LED matrix panels - [X](https://x.com/Yakroo5077/status/2051631181746356693) and [YouTube](https://www.youtube.com/shorts/h6og9MotaJA).

[![Python isn’t always easy](../assets/20260511/20260511easy.jpg)](https://www.infoworld.com/article/4166769/python-isnt-always-easy.html)

Python isn’t always easy - [InfoWorld](https://www.infoworld.com/article/4166769/python-isnt-always-easy.html).
...
[![Maker Go ESP32P4C5 core board](../assets/20260511/20260511new1.jpg)](https://www.cnx-software.com/2026/05/04/esp32-p4-esp32-c5-board-features-raspberry-pi-compatible-mipi-connectors-for-official-displays-and-camera-modules/)

The Maker Go ESP32P4C5 core board features an ESP32-P4-Module with ESP32-P4 MCU with 32MB PSRAM, an ESP32-C5 dual-band WiFi 6 SoC, and a 16MB NOR flash. Besides the MIPI connectors, the board features three USB ports, one for debugging, and two Type-C/A ports sharing a USB 2.0 data connection, a built-in MEMS microphone, a speaker connector, and two 34-pin headers for expansion - [CNX](https://www.cnx-software.com/2026/05/04/esp32-p4-esp32-c5-board-features-raspberry-pi-compatible-mipi-connectors-for-official-displays-and-camera-modules/).

[![Renesas WS125-V2HRDKREFZ](../assets/20260511/20260511new2.jpg)](https://www.cnx-software.com/2026/05/05/renesas-rz-v2h-robotics-development-kit-handles-ai-vision-motor-control-and-power-management-with-a-single-board/)

Renesas WS125-V2HRDKREFZ is a Robotics Development Kit (RDK) powered by Renesas RZ/V2H Arm Cortex-A55/R8/M33 microprocessor and designed for high‑performance AI vision applications leveraging the MPU’s built-in 80 TOPS (sparse) AI accelerator. The kit ships with 16GB LPDDR4, 64MB QSPI flash, a 64GB microSD card, a 40-pin Raspberry Pi GPIO header, a 16-pin PCIe Gen3 FFC connector, two MIPI CSI connectors, and a micro HDMI port. Other features include a Gigabit Ethernet port, two USB 3.2 ports, two CAN-FD interfaces, and a 12-24V DC input voltage range - [CNX](https://www.cnx-software.com/2026/05/05/renesas-rz-v2h-robotics-development-kit-handles-ai-vision-motor-control-and-power-management-with-a-single-board/).

## New Boards Supported by CircuitPython

The number of supported microcontrollers and Single Board Computers (SBC) grows every week. This section outlines which boards have been included in CircuitPython or added to [CircuitPython.org](https://circuitpython.org/).

This week there were 32 new boards added! For microcontrollers, there are boards that are supported by the emerging CircuitPython Zephyr work. For single board computers, there are boards which can use the Blinka compatibility layer which uses U2IF, allows you to run "regular" Python code on your main computer and have it communicate with external devices connected through an RP2040 board ([Learn Guide for this](https://learn.adafruit.com/circuitpython-libraries-on-any-computer-with-raspberry-pi-pico)).
...
[![Learn Guides](../assets/20260511/20260511learn.jpg)](https://learn.adafruit.com/guides/latest)
...
CircuitPython's stable release is [10.1.4](https://github.com/adafruit/circuitpython/releases/latest) and its unstable release is [10.3.0-beta.1](https://github.com/adafruit/circuitpython/releases). New to CircuitPython? Start with our [Welcome to CircuitPython Guide](https://learn.adafruit.com/welcome-to-circuitpython).
...
[3.14.4](https://www.python.org/downloads/) is the latest Python release. The latest pre-release version is [3.15.0b1](https://www.python.org/download/pre-releases/).
...
[![39,024 THANKS](../assets/20260511/39kdiscord.jpg)](https://adafru.it/discord)
