...
This LEDarcade clock runs on Raspberry Pi, features retro arcade games, and shows time in style. It uses a Raspberry Pi 3, an Adafruit LED Matrix, and an RGB Hat, and uses Python - [XDA](https://www.xda-developers.com/stunning-raspberry-pi-arcade-clock/).
