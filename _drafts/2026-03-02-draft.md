---
layout: post
title: "Resources for Learning Python, Handy Projects, and Much More!"
...
Welcome to the latest Python on Microcontrollers newsletter! Your editor is recovering from bad food poisoning but that will not deter me from finding content you can use today. This week, there is an abundance of MicroPython resources and lists below to help you get through using Python, and a bit of AI too, as it seems it is here to stay. On the socials, more folks are programming with AI and converting programs written in one language to Python for hardware. That's ok, but it's best to double check what the LLM provides. And look at policies like [MicroPython's AI Disclosure](https://github.com/micropython/micropython/wiki/ContributorGuidelines#generative-ai-policy) policy before submitting code to others. - *Anne Barela, Editor*

We're on [Discord](https://discord.gg/HYqvREz), [Twitter/X](https://twitter.com/search?q=circuitpython&src=typed_query&f=live), [BlueSky](https://bsky.app/profile/circuitpython.org) and for past newsletters - [view them all here](https://www.adafruitdaily.com/category/circuitpython/). If you're reading this on the web, please [subscribe here](https://www.adafruitdaily.com/). Here's the news this week:

## µReticulum for MicroPython Released

[![µReticulum](../assets/20260302/20260302mr.jpg)](https://github.com/varna9000/micropython-reticulum)
...
[![Bringing Flip-Dot Displays Into the 21st Century](../assets/20260302/20260302flip.jpg)](https://codeberg.org/generallyokay/pages/src/branch/main/flipdot-bad-apple-2026.md)
...
[![Deep Dive](../assets/20260302/20260302deepdive.jpg)](https://youtube.com/live/pVHLFO5bzsk)

[Last Friday](https://youtube.com/live/pVHLFO5bzsk), Scott streamed work on CircuitPython `displayio` on Zephyr.

You can see the latest video and past videos on the Adafruit YouTube channel under the Deep Dive playlist - [YouTube](https://www.youtube.com/playlist?list=PLjF7R1fz_OOXBHlu9msoXq2jQN4JpCk8A).

**CircuitPython Parsec**

[![CircuitPython Parsec](../assets/20260302/20260302jp.jpg)](https://blog.adafruit.com/2026/02/27/john-parks-circuitpython-parsec-neotrellis-midi-keyboard/)

John Park’s CircuitPython Parsec this week is on the NeoTrellis MIDI Keyboard
 - [Adafruit Blog](https://blog.adafruit.com/2026/02/27/john-parks-circuitpython-parsec-neotrellis-midi-keyboard/) and [YouTube](https://youtu.be/cju7YxWgAg8).
...
[![Cheat Sheet](../assets/20260302/20260302cs.jpg)](https://x.com/yourclouddude/status/2025509521137729820)

A good Python cheat sheet - [X](https://x.com/yourclouddude/status/2025509521137729820).

Bonus: Python Libraries for AI and Machine Learning cheat sheet for beginners - [X](https://x.com/PythonPr/status/2026191613899477206).

[![TVArgenta](../assets/20260302/20260302tv.jpg)](https://rsflightronics.com/tvargenta-una-tele-para-volver-a-casa)

TVArgenta is a retro TV that revives the magic of the 90s. Using a Raspberry Pi 4, a display and custom 3D retro-television case, the project plays programs, 90s commercials, and shares a bit of the Argentine culture, all using Python - [RSFlightronics](https://rsflightronics.com/tvargenta-una-tele-para-volver-a-casa), [YouTube](https://www.youtube.com/watch?v=HtbVXglUft0), and [GitHub](https://github.com/rsappia/TVArgenta-Release). Via [Raspberry Pi News](https://www.raspberrypi.com/news/tvargenta-reviving-retro-argentinian-tv/)
...
[![Bluesky weather bot](../assets/20260302/20260302weather.jpg)](https://www.xda-developers.com/bluesky-weather-bot-raspberry-pi-pico-home-lab-simpler/)

A Bluesky weather bot, using a Raspberry Pi Pico W and MicroPython, makes a home lab simpler - [XDA](https://www.xda-developers.com/bluesky-weather-bot-raspberry-pi-pico-home-lab-simpler/) and [GitHub](https://github.com/RecoveringPhoenix/xda-weatherbot).

[![Python Environments Extension for VS Code](../assets/20260302/20260302vsc.jpg)](https://devblogs.microsoft.com/python/python-in-visual-studio-code-february-2026-release/)

Microsoft's new Python Environments Extension for VS Code is in general availability - [Microsoft Dev Blogs](https://devblogs.microsoft.com/python/python-in-visual-studio-code-february-2026-release/).

[![Famicom controller used as a mouse and keyboard on a PC](../assets/20260302/20260302fam.jpg)](https://x.com/ume_chba/status/2025928615314215047)

A Famicom controller used as a mouse and keyboard on a PC, using a Raspberry Pi Pico and CircuitPython - [X](https://x.com/ume_chba/status/2025928615314215047).

[![Adding an OLED Display with MicroPython](../assets/20260302/20260302oled.jpg)](https://youtu.be/K0X4W09tiEA?si=TWVETMtMF1nWl8b4)

Adding an OLED Display with MicroPython - [YouTube](https://youtu.be/K0X4W09tiEA?si=TWVETMtMF1nWl8b4).

[![First boot of circuitpython on the Thumby Color](../assets/20260302/20260302thumb.jpg)](https://bsky.app/profile/relic-se.bsky.social/post/3mfkqzjgjbk2i)

First boot of CircuitPython on the Thumby Color - [BlueSky](https://bsky.app/profile/relic-se.bsky.social/post/3mfkqzjgjbk2i).
...
[![Build an AI Agent From Scratch in Python](../assets/20260302/20260302agent.jpg)](https://youtu.be/bTMPwUgLZf0?si=P5ohry3IIpYXDPyL)

Build an AI agent from scratch in Python - [YouTube](https://youtu.be/bTMPwUgLZf0?si=P5ohry3IIpYXDPyL) and [GitHub](https://github.com/techwithtim/PythonAIAgentFromScratch).
...
[![When and why you might need the Raspberry Pi AI HAT+ 2](../assets/20260302/20260302hailo.jpg)](https://www.raspberrypi.com/news/when-and-why-you-might-need-the-raspberry-pi-ai-hat-plus-2/)

When and why you might need the Raspberry Pi AI HAT+ 2 - [Raspberry Pi News](https://www.raspberrypi.com/news/when-and-why-you-might-need-the-raspberry-pi-ai-hat-plus-2/).

[![Password Safe](../assets/20260302/20260302pass.jpg)](https://www.instructables.com/Password-Safe-Keyboard-Injector-Version-50)

A password safe and keyboard injector, version 5.0 with Raspberry Pi Pico and CircuitPython - [Instructables](https://www.instructables.com/Password-Safe-Keyboard-Injector-Version-50).
...
[![PyMateIO Core](../assets/20260302/20260302pm.jpg)](https://www.pymate.io/)

PyMateIO Core is a new industrial controller powered by MicroPython  - [pymate.io](https://www.pymate.io/). Via [X](https://x.com/AndreMller80408/status/2027113999087587634).
...
[Moonshine Voice Control on Raspberry Pi](https://learn.adafruit.com/moonshine-voice-control-on-raspberry-pi) from [Tim C](https://learn.adafruit.com/u/Foamyguy)

[LED Shoji Lamp](https://learn.adafruit.com/led-shoji-lamp) from [Ruiz Brothers](https://learn.adafruit.com/led-shoji-lamp)
