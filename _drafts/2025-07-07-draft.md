...
Visual Studio Code-Server, running on a server, allows any device to connect via a web browser and edit their Python code - [XDA](https://www.xda-developers.com/code-server-changed-my-workflow/).
