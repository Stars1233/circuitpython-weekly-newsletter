...
[![Laputa Stone Door Opener](../assets/20250707/20250707potw.jpg)](https://stevekasuya.com/project/black-stone/)

If you're a fan of Hayao Miyazaki's Castle in the Sky, or just an AWS IoT wizard, you'll appreciate this project. It mimics using the [Laputa](https://ghibli.fandom.com/wiki/Laputa) stone over a cuniform tablet to open an electric lock. The project uses MicroPython, talking to AWS IoT to the lock. The cuniform letters are lit by 120 LEDs and sensors connected to a Raspberry Pi Pico W. This is just a fantastic project - [Steve Kasuya](https://stevekasuya.com/project/black-stone/) and [YouTube](https://youtu.be/OSktIs0ZtyY). 
