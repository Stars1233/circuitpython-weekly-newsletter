...
Welcome to the latest Python on Microcontrollers newsletter! This week was quite busy. CircuitPython.org was finally updated last Friday with a new, fresh look. I highlight a number of classes and tutorials now available. CircuitPython was bumped with a bug fix release (and another is likely next week). Finally, I'd like to extend the community's thanks to CircuitPython core developer Jeff Epler, who is retiring. See the farewell message in the Team Updates. - *Anne Barela, Editor*
