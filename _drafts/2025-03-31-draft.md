...
Python continues to be the #1 language worldwide, gaining over 8% from last month. Also of interest is rising popularity of Delphi/Object Pascal and Ada - [TechReplubic](https://www.techrepublic.com/article/tiobe-index-language-rankings/).
...
Chris Wilson has started a new series of tutorials on hackster.io on using the Zephyr real-time operating system (RTOS) to program the Raspberry Pi Pico 2 - [hackster.io](https://www.hackster.io/cdwilson/zephyr-rtos-on-raspberry-pi-pico-2-part-1-cf39f0).
