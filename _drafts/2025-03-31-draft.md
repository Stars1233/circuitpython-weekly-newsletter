---
layout: post
title: "New CircuitPython.org, Python Is Still #1, Classes and Much More!"
...
Welcome to the latest Python on Microcontrollers newsletter! This week was quite busy. CircuitPython.org was finally updated last Friday with a new, fresh look. This issue highlights a number of classes and tutorials now being offered. CircuitPython was bumped with a bug fix release (and another is likely next week, thanks for all the testing folks). And finally, I'd like to extend the community's thanks to CircuitPython core developer Jeff Epler, who is retiring. See the farewell message in the Team Updates. - *Anne Barela, Editor*
...
Python continues to be the #1 language worldwide, gaining over 8% from last month. Also of interest is the rising popularity of legacy languages Delphi/Object Pascal and Ada - [TechRepublic](https://www.techrepublic.com/article/tiobe-index-language-rankings/).
...
MIT Open CourseWare has an online class available via the internet: 6.100L Introduction to CS and Programming Using Python - [Website](https://ocw.mit.edu/courses/6-100l-introduction-to-cs-and-programming-using-python-fall-2022/) and videos - [YouTube](https://www.youtube.com/playlist?list=PLUl4u3cNGP62A-ynp6v6-LGBCzeH3VAQB). Via [X](https://x.com/MIT_CSAIL/status/1904201586835911140).
...
[![CircuitPython Parsec](../assets/20250331/20250331jp.jpg)](https://blog.adafruit.com/2025/03/28/john-parks-circuitpython-parsec-usb-gamepad-configuration/)

John Park’s CircuitPython Parsec this week is on USB Gamepad Configuration - [Adafruit Blog](https://blog.adafruit.com/2025/03/28/john-parks-circuitpython-parsec-usb-gamepad-configuration/) and [YouTube](https://youtu.be/Ne3X9FhgWDc).
...
[![Solving the upip installing in .frozen Issue on Raspberry Pi Zero W with MicroPython](../assets/20250331/20250331up.jpg)](https://www.youtube.com/watch?v=H2Oqbm9Qcb0)

Solving the upip installing in .frozen Issue on Raspberry Pi Zero W with MicroPython - [YouTube](https://www.youtube.com/watch?v=H2Oqbm9Qcb0).
...
[![CircuitPython Powered Smart Alarm Clock](../assets/20250331/20250331clock.jpg)](https://www.instructables.com/CircuitPython-Powered-Smart-Alarm-Clock/)

CircuitPython powered smart alarm clock on an Adafruit Matrix Portal M4 - [Instructables](https://www.instructables.com/CircuitPython-Powered-Smart-Alarm-Clock/).
...
[![Adafruit ESP32-S3 Reverse TFT with w.FL Antenna](../assets/20250331/20250331new2.jpg)](https://www.adafruit.com/product/6303)

Adafruit ESP32-S3 Reverse TFT with w.FL Antenna - [Adafruit](https://www.adafruit.com/product/6303).
...
CircuitPython's stable release is [9.2.6](https://github.com/adafruit/circuitpython/releases/latest). New to CircuitPython? Start with our [Welcome to CircuitPython Guide](https://learn.adafruit.com/welcome-to-circuitpython).
...
[4,232 Stars](https://github.com/adafruit/circuitpython/stargazers) Like CircuitPython? [Star it on GitHub!](https://github.com/adafruit/circuitpython)
...
[![38,883 THANKS](../assets/20250331/38kdiscord.jpg)](https://adafru.it/discord)

[![Adafruit Discord](https://discordapp.com/api/guilds/327254708534116352/embed.png?style=banner3)](https://discord.gg/adafruit)

The Adafruit Discord community, where we do all our CircuitPython development in the open, reached over 38,883 humans - thank you! Adafruit believes Discord offers a unique way for Python on hardware folks to connect. Join today at [https://adafru.it/discord](https://adafru.it/discord).
