...
[![The Ultimate Fusion 360 Controller](../assets/20260209/20260209-name.jpg)](https://www.youtube.com/watch?v=AjmmTDKetks)

A DIY Macro Pad and Space Mouse using a Raspberry Pi Pico and CircuitPython. It’s a complete productivity station for Fusion 360, Blender, and coding. It features a custom 5x5 mechanical key matrix, two rotary encoders for scrolling and volume, and a custom-built 6-DOF Space Mouse (magnetometer-based) that lets you orbit, pan, and zoom in 3D space - [site](https://www.youtube.com/watch?v=AjmmTDKetks) and [GitHub](https://github.com/jeevan8232/macrokeyboard).
