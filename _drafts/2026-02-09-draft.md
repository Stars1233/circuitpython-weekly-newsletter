...
circfirm v5 is now out, now officially supporting Python 3.14. This version updated the dependencies and added Dependabot to that end. You can easily manage and install CircuitPython firmware versions onto your development boards from command line - [GitHub](https://github.com/tekktrik/circfirm) and [Mastodon](https://mastodon.social/@tekktrik@techhub.social/116021203126292711).
