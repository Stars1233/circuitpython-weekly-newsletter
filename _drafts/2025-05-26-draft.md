...
Welcome to the latest Python on Microcontrollers newsletter. This week's issue takes a look at Microsoft and news from their latest Build conference. They are open sourcing some software and adbopting MCP for securing AI agents on Windows. If you missed PyCon US 2025, the talk videos are up on YouTube. And a nice article on how MicroPython is again gooing into space. Oodles of great information from around the world including an up to date Python 3 cheat sheet. Let the sun shine in. - *Anne Barela, Editor*
