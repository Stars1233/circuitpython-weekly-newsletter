...
SemiTO-V RP2350 expansion cards for Framework laptops. Micropython firmware REPL running on the RP2350 based card, with DC-ROMA RISC-V Mainboard accessing it via UART with minicom. 2 RISC-V hardware working together - [X](https://x.com/semito_v/status/1976390218669490406).
