---
layout: post
title: "Qualcomm Nabs Arduino, MicroPython OSes, Python 3.14 Out and More!"
...
Python 3.12.12, 3.11.14, 3.10.19 and 3.9.24 are now available! - [Python Insider Blog](https://pythoninsider.blogspot.com/2025/10/python-31212-31114-31019-and-3924-are.html).
...
[![CircuitPython 10.0.1](../assets/20251013/20251013cp10.jpg)](https://github.com/adafruit/circuitpython/releases/tag/10.0.1)

CircuitPython 10.0.1 is the latest bugfix revision of CircuitPython and is the new stable release. It fixes a 10.0.0 regression preventing writing to a filesystem other than CIRCUITPY via USB - [GitHub](https://github.com/adafruit/circuitpython/releases/tag/10.0.1).
...
Maker Faire Rome is coming up this week. While the big news will likely be the Arduino acquisition, Microchip will be there with demonstrations including with CircuitPython and folks like Raspberry Pi and DigiKey will be there also - [MakerFaireRome](https://makerfairerome.eu/en/blog/microchip-technology-innovation-creativity-and-technologies-for-makers/).
...
[![Deep Dive](../assets/20251013/20251013deepdive.jpg)](https://youtube.com/live/31XeEVjqn8k)

[Last Friday](https://youtube.com/live/31XeEVjqn8k), Tim streamed work on preparing a patch for CircuitPython libraries.

You can see the latest video and past videos on the Adafruit YouTube channel under the Deep Dive playlist - [YouTube](https://www.youtube.com/playlist?list=PLjF7R1fz_OOXBHlu9msoXq2jQN4JpCk8A).

**CircuitPython Parsec**

[![CircuitPython Parsec](../assets/20251013/20251013jp.jpg)](https://blog.adafruit.com/2025/10/10/john-parks-circuitpython-parsec-spyce-invaders-splash-screen/)

John Park’s CircuitPython Parsec this week is on Spyce Invaders Splash Screen - [Adafruit Blog](https://blog.adafruit.com/2025/10/10/john-parks-circuitpython-parsec-spyce-invaders-splash-screen/) and [YouTube](https://youtu.be/dPsOIZGSbuw).
...
[![The Official Raspberry Pi Handbook 2026](../assets/20251013/20251013book.jpg)](https://www.raspberrypi.com/news/the-official-raspberry-pi-handbook-2026-is-here/)

The Official Raspberry Pi Handbook new 2026 edition is out now - [Raspberry Pi News](https://www.raspberrypi.com/news/the-official-raspberry-pi-handbook-2026-is-here/).
...
[![Retro TV](../assets/20251013/20251013tv.jpg)](https://www.instructables.com/Build-Your-Own-Retro-TV-With-Raspberry-Pi-Offline-/)

Build your own retro TV With Raspberry Pi and Python - [Instructables](https://www.instructables.com/Build-Your-Own-Retro-TV-With-Raspberry-Pi-Offline-/).

[![Raspberry Pi Pico 2 W + Arducam OV2640](../assets/20251013/20251013cam.jpg)](https://www.instructables.com/Raspberry-Pi-Pico-2-W-Arducam-OV2640-Simple-Photo-/)

Raspberry Pi Pico 2 W + Arducam OV2640: simple photo capture to on-device storage with CircuitPython - [Instructables](https://www.instructables.com/Raspberry-Pi-Pico-2-W-Arducam-OV2640-Simple-Photo-/).

[![A console memory card reader using a Raspberry Pi Pico and MicroPython](../assets/20251013/20251013cr.jpg)](https://blog.adafruit.com/2025/10/06/a-console-memory-card-reader-using-a-raspberry-pi-pico-and-micropython/)

A console memory card reader using a Raspberry Pi Pico and MicroPython - [Adafruit Blog](https://blog.adafruit.com/2025/10/06/a-console-memory-card-reader-using-a-raspberry-pi-pico-and-micropython/) and [GitHub](https://github.com/jareklupinski/memcard-dumper?tab=readme-ov-file).
...
[![title](../assets/20251013/20251013proj.jpg)](https://mastodon.social/@knasman@fosstodon.org/115331041352951148)

An Adafruit QT Py running a real time clock and a precision temp humidity sensor with an added the “cylon” NeoPixel strip with CircuitPython - [Mastodon](https://mastodon.social/@knasman@fosstodon.org/115331041352951148).

[![ESP32 and Termux](../assets/20251013/20251013esp.jpg)](https://blog.gavide.dev/blog/esp32-and-termux)

ESP32 and Termux with MicroPython - [gavide.dev](https://blog.gavide.dev/blog/esp32-and-termux).

[![RAK11160: Running MicroPython on the ESP core](../assets/20251013/20251013rak.jpg)](https://digitalsober.wordpress.com/2025/09/28/rak11160-running-micropython-on-the-esp-core/)

RAK11160: Running MicroPython on the ESP core - [Mastodon](https://digitalsober.wordpress.com/2025/09/28/rak11160-running-micropython-on-the-esp-core/).

[![Roulette](../assets/20251013/20251013rou.jpg)](https://www.instructables.com/Rouled-on-the-Trail-of-Happiness/)

Roulette project with NeoPixels, Pi Pico and MicroPython - [instructables](https://www.instructables.com/Rouled-on-the-Trail-of-Happiness/).

[![Quick Setup Guide for W6300-EVB-PICO2 with CircuitPython](../assets/20251013/20251013quick.jpg)](https://www.youtube.com/shorts/AlNEhvl1jqE)

Quick setup guide for tthe W6300-EVB-PICO2 with CircuitPython - [YouTube](https://www.youtube.com/shorts/AlNEhvl1jqE).
...
[![Shawn Hymel](../assets/20251013/20251013rust.jpg)](https://x.com/ShawnHymel/status/1976716163951608293)

Shawn Hymel is hosting a workshop on Embedded Rust at the Hackaday SuperCon October 31-November 1 - [X](https://x.com/ShawnHymel/status/1976716163951608293).
...
[![SemiTO-V](../assets/20251013/20251013new2.jpg)](https://x.com/semito_v/status/1976390218669490406)

SemiTO-V RP2350 expansion cards for Framework laptops. Micropython firmware REPL running on the RP2350 based card, with DC-ROMA RISC-V Mainboard accessing it via UART with minicom. 2 RISC-V hardware working together - [X](https://x.com/semito_v/status/1976390218669490406) and [GitHub](https://github.com/semitov/rp2350-gpio-card).
...
Here are this week's new CircuitPython libraries:
  ...
  * [adafruit/Adafruit_CircuitPython_SSD1683](https://github.com/adafruit/Adafruit_CircuitPython_SSD1683)
...
Here are this week's updated CircuitPython libraries:
  ...
  * [adafruit/Adafruit_CircuitPython_UC8253](https://github.com/adafruit/Adafruit_CircuitPython_UC8253)
...
CircuitPython's stable release is [10.0.1](https://github.com/adafruit/circuitpython/releases/latest). New to CircuitPython? Start with our [Welcome to CircuitPython Guide](https://learn.adafruit.com/welcome-to-circuitpython).

[20251010](https://github.com/adafruit/Adafruit_CircuitPython_Bundle/releases/latest) is the latest Adafruit CircuitPython library bundle.
...
[3.14.0](https://www.python.org/downloads/) is the latest Python release.

[4,353 Stars](https://github.com/adafruit/circuitpython/stargazers) Like CircuitPython? [Star it on GitHub!](https://github.com/adafruit/circuitpython)
...
[![39,030 THANKS](../assets/20251013/39kdiscord.jpg)](https://adafru.it/discord)

[![Adafruit Discord](https://discordapp.com/api/guilds/327254708534116352/embed.png?style=banner3)](https://discord.gg/adafruit)

The Adafruit Discord community, where we do all our CircuitPython development in the open, reached over 39,030 humans - thank you! Adafruit believes Discord offers a unique way for Python on hardware folks to connect. Join today at [https://adafru.it/discord](https://adafru.it/discord).
