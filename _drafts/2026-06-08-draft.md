...
The piBrick Pocket-CM5 is a compact DIY handheld PC based on the Raspberry Pi. It features the latest Raspberry Pi CM5 as its core and is characterized by its physical keyboard and AMOLED (organic EL) display - [Daily Gadget](https://daily-gadget.net/gadgets/115329/). (Japanese)
