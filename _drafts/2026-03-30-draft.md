...
Adding a pattern chain function to the Roland AIRA Compact synth. It allows for 8 chains, with 2 fill-ins set per chain. Built using the Adafruit MacroPad RP2040 + CircuitPython. This lets it do pattern operations letting the user focus on controlling the 303 - [X](https://x.com/mugenkidou/status/2036451939685376371).
