---
layout: post
title: "The Python Developers Survey, Espressif News, Malware and More!"
...
[![I Gave My Macropad an OLED (and Then Animated It)](../assets/20260330/20260330pad.jpg)](https://www.youtube.com/watch?v=QAcuAJAVwQ8)

Giving a macropad an OLED display (and then animating it) with an RP2040 and KMK firmware, which uses CircuitPython - [YouTube](https://www.youtube.com/watch?v=QAcuAJAVwQ8).
...
[Close Encounters of the MIDI NeoPixel Visualizer Kind](https://learn.adafruit.com/midi-neopixel-visualizer) from [Ruiz Brothers](https://learn.adafruit.com/u/pixil3d)
