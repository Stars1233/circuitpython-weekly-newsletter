...
It's been 18 months since [reporting last](https://github.com/jyoberle/micropython-amiga) on an AmigaOS port of MicroPython. Fabrice has a new port targeting MicroPython v1.27.0 targeting Motorola 68020+ processors. It runs on classic Amiga hardware (A1200, A3000, A4000) and emulators (WinUAE, FS-UAE) - [GitHub](https://github.com/OoZe1911/micropython-amiga-port) and [Aminet](). Via [Ganeration Amiga](https://www.generationamiga.com/2026/03/26/micropython-in-development-for-the-commodore-amiga-a-modern-language-on-classic-hardware/).
...
The [SPOKE CircuitPython multifunction board](https://www.spokeboard.com/) now has a new web-based development environment [here](https://tom-vulpes.github.io/SpokeWebMidi/playground.html). After a successful Kickstarter, it is being manufactured in the UK and will be available from Pimoroni in coming weeks - [BlueSky](https://bsky.app/profile/vulpeslabs.bsky.social/post/3mhbskjtwks2y).
...
[![Deep Dive](../assets/20260330/20260330deepdive.jpg)](link)
...
[![CircuitPython Parsec](../assets/20260330/20260330jp.jpg)](link)
...
A 12-year-old boy had created a time attack feature for a toy where Thomas the Tank Engine goes around in a circle while operating a lever, using electronics tinkering. From the setup and wiring to the program using MicroPython, he assembled everything himself, with a mechanism that counts it as a goal when it reacts to the ultrasonic distance sensor near the finish line - [X](https://x.com/foka22ok/status/2037450355332776032) (Japanese).
