---
layout: post
title: "Choosing a Microcontroller, CircuitPython Video and Much More!"
...
Adafruit has been working on graphical software upgrades for Raspberry Pi RP2040 and RP2350 microcontrollers. Much of the work is to complement the upcoming Fruit Jam board but are also applicable to other HSTX capable boards such as the Feather RP2350 and Metro RP2350. Above is a demonstration using random colored lines in a screensaver-like display. HSTX based video is awesome in that it takes little CPU power and does not use PIO resources - [YouTube](https://www.youtube.com/watch?v=pcYgTKpxS6c) and [Adafruit Blog](https://blog.adafruit.com/2025/02/19/hstx-dvi-output-on-fruit-jam/). Via [X](https://x.com/adafruit/status/1892308517090185435).

[![CircuitPython Video Upgrades](../assets/20250224/20250224text.gif)](https://blog.adafruit.com/2025/02/19/text-mode-hstx-dvi-output-on-the-fruit-jam/)
...
Chess using a touch display running MicroPython - [GitHub](https://github.com/orgs/micropython/discussions/16791) and [GitHub](https://github.com/peterhinch/micropython-touch/blob/master/optional/chess/CHESS.md).
...
[![To update circup](../assets/20250224/20250224cir.jpg)](https://www.youtube.com/watch?v=lg8MwjHDa2M)

Installing and using CircUp (CircuitPython library updater) to install CircuitPython libraries - [YouTube](https://www.youtube.com/watch?v=lg8MwjHDa2M).

[![Python Software Foundation (PSF) online - 2025](../assets/20250224/20250224psf.jpg)](https://pyfound.blogspot.com/2025/02/where-is-psf-2025-edition.html)

Where is the Python Software Foundation (PSF) online - 2025 Edition - [PSF Blog](https://pyfound.blogspot.com/2025/02/where-is-psf-2025-edition.html).
