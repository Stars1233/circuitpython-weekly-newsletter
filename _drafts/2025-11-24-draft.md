---
layout: post
title: "Python Still #1, A Pi Business Card, New Python 3.15 beta and More!"
...
Welcome to the latest Python on Microcontrollers newsletter! I hope this email finds you through the deluge of holiday shopping solicitations. No selling here, only good information to keep you informed on Python et al. when the world seems to be so frantic. 

One thing I have not covered in this issue is the flap about Qualcomm changing Arduino's terms and conditions. You can read what [The Register](https://blog.adafruit.com/2025/11/21/makers-slam-qualcomm-for-tightening-the-clamps-on-arduino-theregister/) has written and [Arduino's initial response](https://blog.arduino.cc/2025/11/21/the-arduino-terms-of-service-and-privacy-policy-update-setting-the-record-straight/) but this is not a closed topic in the Maker community. I hope to have a complete picture for you by next week. I hope that your holidays (and perhaps any shopping) goes well. - *Anne Barela, Editor*
...
MicroPython developers had targeted November 14th for release of version 1.27.0. To date, they are 52% to completion, likely due to an ambitious list of features and pull requests - [GitHub](https://github.com/micropython/micropython/milestone/11).

You can download a preview version - [click on your board](https://micropython.org/download/) on their website and there should be current and preview builds listed.
...
Christian Walther's presentation at the Swiss Python Summit, a lightning talk about “Embedding #MicroPython on Playdate,” is now available - [Mastodon](https://mastodon.social/@isziaui@mstdn.social/115561124781286979).

[![3D printed metronome](../assets/20251124/20251124nome.jpg)](https://www.instructables.com/3D-Printed-Metronome-With-CPX/)

A 3D printed metronome with Circuit Playground Express and CircuitPython - [Instructables](https://www.instructables.com/3D-Printed-Metronome-With-CPX/).
...
- [ESP32S3-TOUCH-LCD-2.8 by Waveshare](https://circuitpython.org/board/waveshare_esp32_s3_touch_lcd_2_8/)
- [ESP32-S3-Touch-LCD-1.47 by Waveshare](https://circuitpython.org/board/waveshare_esp32_s3_touch_lcd_1_47/)
- [M5Stack Tab5 IoT Development Kit by M5Stack](https://circuitpython.org/board/m5stack_tab5/)
- [ESP32-C61-DevKitC-1-N8R2 by Espressif](https://circuitpython.org/board/espressif_esp32c61_devkitc_1_n8r2/)
...
[50 Cent CPI Tracker for MagTag](https://learn.adafruit.com/50-cent-cpi-tracker-for-magtag) from [Tim C](https://learn.adafruit.com/u/Foamyguy)
...
There were no new or updated libraries.
...
I have parts of a native ESP32SPI module working. After a discussions with Scott and Tim, I'm going to migrate this code toward a native implementation of the `wifi`, `socketpool`, and `ssl` modules that uses the ESP32SPI functionality under the covers. This will allow AirLift-based projects to use almost the same code as native WiFi projects, and will also enable the web workflow on boards with an AirLift co-processor.
...
[20251119](https://github.com/adafruit/CircuitPython_Community_Bundle/releases/latest) is the latest CircuitPython Community library bundle.
...
[3..14.0](https://www.python.org/downloads/) is the latest Python release. The latest pre-release version is [3.15.0a2](https://www.python.org/download/pre-releases/).

[4,390 Stars](https://github.com/adafruit/circuitpython/stargazers) Like CircuitPython? [Star it on GitHub!](https://github.com/adafruit/circuitpython)
...
[![39,083 THANKS](../assets/20251124/39kdiscord.jpg)](https://adafru.it/discord)

[![Adafruit Discord](https://discordapp.com/api/guilds/327254708534116352/embed.png?style=banner3)](https://discord.gg/adafruit)

The Adafruit Discord community, where we do all our CircuitPython development in the open, reached over 39,083 humans - thank you! Adafruit believes Discord offers a unique way for Python on hardware folks to connect. Join today at [https://adafru.it/discord](https://adafru.it/discord).
