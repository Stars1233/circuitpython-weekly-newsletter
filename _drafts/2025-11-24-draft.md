...
One thing I have not covered in this issue is the flap about Qualcomm changing Arduino's terms and conditions. You can read what [The Register](https://blog.adafruit.com/2025/11/21/makers-slam-qualcomm-for-tightening-the-clamps-on-arduino-theregister/) has written and [Arduino's initial response](https://blog.arduino.cc/2025/11/21/the-arduino-terms-of-service-and-privacy-policy-update-setting-the-record-straight/) but this is not a closed topic in the Maker community and I hope to have a complete picture for you by next week. I hope that your holidays (and perhaps any shopping) goes well. - *Anne Barela, Editor*
