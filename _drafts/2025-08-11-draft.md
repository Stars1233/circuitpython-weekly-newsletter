---
layout: CircuitPython Day is Friday, MicroPython v1.26.0 Release Soon and More!
...
Changes in the schedule will be made in [this blog post](https://blog.adafruit.com/2025/07/28/circuitpython-day-is-august-15-2025/) so please bookmark it.

## MicroPython v1.26.0 Nears Release

[![MicroPython v1.26](../assets/20250811/20250811mp26.jpg)](https://github.com/micropython/micropython/milestone/10)

As of Thursday August 7th, all open issues for MicroPython release-1.26.0 had been closed. It is expected the release will be tagged and made official at any time - [GitHub](https://github.com/micropython/micropython/milestone/10). Via [X](https://x.com/ngc6589/status/1951670616970740071) and [Mastodon](https://mastodon.social/@scruss@xoxo.zone/114965324154257577).
...
[![Python 3.13.6 Released](../assets/20250811/20250811psf.jpg)](https://pythoninsider.blogspot.com/2025/08/python-3136-is-now-available.html)

Python 3.13.6, the sixth maintenance release of Python 3.13, was released August 6th, containing around 200 bugfixes, build improvements and documentation changes since 3.13.5 - [Python Insider Blog](https://pythoninsider.blogspot.com/2025/08/python-3136-is-now-available.html).

## SparkFun Ported OpenCV to MicroPython

[![Ported OpenCV to MicroPython](../assets/20250811/20250811opencv.jpg)](https://www.youtube.com/watch?v=GmIq753MlGQ)

SparkFun has ported [OpenCV](https://opencv.org/), the open computer vision library, to MicroPython, for performing real-time computer vision on microcontrollers. They show a demonstration using a Raspberry Pi RP2350 microcontroller - [YouTube](https://www.youtube.com/watch?v=GmIq753MlGQ).
...
[![CircuitPython Parsec](../assets/20250811/20250811jp.jpg)](https://blog.adafruit.com/2025/08/08/john-parks-circuitpython-parsec-nintendo-wii-classic-controllers/)

John Park’s CircuitPython Parsec this week is on {subject} - [Adafruit Blog](https://blog.adafruit.com/2025/08/08/john-parks-circuitpython-parsec-nintendo-wii-classic-controllers/) and [YouTube](https://youtu.be/BEgLP4L4nDo).

Catch all the episodes in the [YouTube playlist](https://www.youtube.com/playlist?list=PLjF7R1fz_OOWFqZfqW9jlvQSIUmwn9lWr).

## Project of the Week: A Upcycled Raspberry Pi Music Player

[![Custom Raspberry Pi Music Player](../assets/20250811/20250811potw.jpg)](https://www.instructables.com/Custom-Raspberry-Pi-Music-Player-Powered-by-Raspbe/)

Upcycling an older Sony mini-boombox to play music with a Raspberry Pi 4 and Pico and MusicPi, a Python-based system. It includes two LCD displays and a keyboard hidden inside the CD player - [Instructables](https://www.instructables.com/Custom-Raspberry-Pi-Music-Player-Powered-by-Raspbe/) and [YouTube](https://youtu.be/st0GN5Wyn0o).
...
[![Raspberry Pi Pico W: Bluetooth Low Energy (BLE) with MicroPython](../assets/20250811/20250811ble.jpg)](https://randomnerdtutorials.com/raspberry-pi-pico-w-bluetooth-low-energy-micropython/l)

Raspberry Pi Pico W: Bluetooth Low Energy (BLE) with MicroPython - [Randoom Nerd Tutorials](https://randomnerdtutorials.com/raspberry-pi-pico-w-bluetooth-low-energy-micropython/).
...
[![Clockwork PicoCalc: Performance comparison between Rasp pico, pico2W and MMBASIC on the PicoCalc](../assets/20250811/20250811picocalc.jpg)](https://www.youtube.com/watch?v=BP6YqF62IoA)

Clockwork PicoCalc: a performance comparison between Raspberry Pi Pico, Pico 2W and MMBASIC on the PicoCalc - [YouTube](https://www.youtube.com/watch?v=BP6YqF62IoA).
...
[![Writing Text to Displays Using Raspberry Pi Pico and DisplayIO (CircuitPython School)](../assets/20250811/20250811pg1.jpg)](https://www.youtube.com/watch?v=-lrJ0fy0xm0)

Writing Text to Displays Using Raspberry Pi Pico and DisplayIO (CircuitPython School) - [YouTube](https://www.youtube.com/watch?v=-lrJ0fy0xm0).

[![RGBY (Red, Green, Blue, Yellow) a Memory Game](../assets/20250811/20250811memory.jpg)](https://www.instructables.com/RGBY-Red-Green-Blue-Yellow-a-Memory-Game/)

RGBY (Red, Green, Blue, Yellow) a Memory Game in MicroPython - [Instructables](https://www.instructables.com/RGBY-Red-Green-Blue-Yellow-a-Memory-Game/).

[![uht: Minimal HTTP server for MicroPython and CircuitPython](../assets/20250811/20250811uht.jpg)](https://github.com/nmattia/uht)

uht: a minimal HTTP server for MicroPython and CircuitPython, MIT license - [GitHub](https://github.com/nmattia/uht).

[![Pocket Deck](../assets/20250811/20250811deck.jpg)](https://www.youtube.com/watch?v=t5U8vJeiXoE)

Pocket Deck is a standalone portable computer for taking note and journaling, with a text editor and terminal. It can be expanded with MicroPython - [YouTube](https://www.youtube.com/watch?v=t5U8vJeiXoE).
...
I've been working on updating the Learn Guides to describe more thoroughly how to update TinyUF2 and CircuitPython on Espressif boards. I wrote a guide (under review) about how to use the OPEN INSTALLER button on [circuitpython.org](http://circuitpython.org/).
...
[20250807](https://github.com/adafruit/Adafruit_CircuitPython_Bundle/releases/latest) is the latest Adafruit CircuitPython library bundle.
...
[3.13.6](https://www.python.org/downloads/) is the latest Python release. The latest pre-release version is [3.14.0rc1](https://www.python.org/download/pre-releases/).

[4,314 Stars](https://github.com/adafruit/circuitpython/stargazers) Like CircuitPython? [Star it on GitHub!](https://github.com/adafruit/circuitpython)
