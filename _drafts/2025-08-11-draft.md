...
SparkFun has ported [OpenCV](https://opencv.org/), the open computer vision library, to MicroPython, for performing real-time computer vision on microcontrollers. They show a demonstration using a Raspberry Pi RP2350 microcontroller - [YouTube](https://www.youtube.com/watch?v=GmIq753MlGQ) and [SparkFun](https://news.sparkfun.com/14463).
