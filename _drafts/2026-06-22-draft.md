---
layout: post
title: "Code Like Hemingway, CircuitPython MCP, MicroPython Editor and More!"
...
Welcome to the latest Python on Microcontrollers newsletter! "Pass the sunscreen" I ask, as I contemplate going out to sunny Lake Michigan. I did get to finding a great selection of Python news for folks before grabbing the picnic basket. People don't know how AI might work with their coding. The human concentrating on the spec seems to be an important part of the process. And when AI helps you, what kind of software licensing applies? A couple of goodies: An MCP server is now available for CircuitPython while a new editor has been launched for MicroPython. There are some Raspberry Pi items this week and a well-balanced group of MicroPython and CircuitPython projects so look over. I hope you all have a great week. - *Anne Barela, Editor*
...
Frederick Blais has created an open source CircuitPython MCP Server, a minimal set of MCP JSON-RPC server helpers for CircuitPython projects using `adafruit_httpserver` - [GitHub](https://github.com/speccy88/circuitpython-mcp-server).
...
Latest Raspberry Pi OS Release Is Powered by Linux Kernel 6.18 LTS - [9to5Linux](https://9to5linux.com/latest-raspberry-pi-os-release-is-powered-by-linux-kernel-6-18-lts).
...
[![Deep Dive](../assets/20260622/20260622deepdive.jpg)](https://youtube.com/live/8pMb9IWA9h4)

[Last Friday](https://youtube.com/live/8pMb9IWA9h4), Tim filled in for Scott and spoke about the `usb_audio` core module.

You can see the latest video and past videos on the Adafruit YouTube channel under the Deep Dive playlist - [YouTube](https://www.youtube.com/playlist?list=PLjF7R1fz_OOXBHlu9msoXq2jQN4JpCk8A).

**CircuitPython Parsec**

[![CircuitPython Parsec](../assets/20260622/20260622jp.jpg)](https://blog.adafruit.com/2026/06/19/john-parks-circuitpython-parsec-lcd-character-marquee-scroll/)

John Park’s CircuitPython Parsec this week is on LCD Character Marquee Scroll - [Adafruit Blog](https://blog.adafruit.com/2026/06/19/john-parks-circuitpython-parsec-lcd-character-marquee-scroll/) and [YouTube](https://youtu.be/E8fOIcs5Cao?si=s2pxsxwU1AA1lJIZ).

Catch all the episodes in the [YouTube playlist](https://www.youtube.com/playlist?list=PLjF7R1fz_OOWFqZfqW9jlvQSIUmwn9lWr).

**Deep Dive with Tim**

[![Deep Dive with Tim](../assets/20260622/20260622timdive.jpg)](https://youtube.com/live/ebnnDnVsnfc)

[Last week](https://youtube.com/live/ebnnDnVsnfc), Tim was looking into USB Audio in TinyUSB.
...
CircuitPython Weekly Meeting for June 15, 2026 ([notes](https://github.com/adafruit/adafruit-circuitpython-weekly-meeting/blob/main/2026/2026-06-15.md)) [on YouTube](https://youtu.be/jxK8BoIql18).
...
[![Raspberry Pi Imager 2.0.10](../assets/20260622/20260622img.jpg)](https://linuxiac.com/raspberry-pi-imager-2-0-10-adds-pi-connect-for-organization-support/)

Raspberry Pi Imager 2.0.10 adds Pi Connect for Organization Support, CM5 secure boot re-provisioning, accessibility updates, and write fixes - [Linuxiac](https://linuxiac.com/raspberry-pi-imager-2-0-10-adds-pi-connect-for-organization-support/). Via [BlueSky](https://bsky.app/profile/linuxiac.bsky.social/post/3monn4ifikc2t).

[![Setting Up Raspberry Pi Pico 2 W with Live Debugging](../assets/20260622/20260622set.jpg)](https://www.youtube.com/watch?v=5EumkJWdgek)

Setting up Raspberry Pi Pico 2 W with live debugging - [YouTube](https://www.youtube.com/watch?v=5EumkJWdgek).

[![LCD1602 bigfont number](../assets/20260622/20260622lcd.gif)](https://www.hackster.io/shaoziyang/lcd1602-bigfont-number-300551)

LCD1602 bigfont number displays large fonts on an LCD1602 display with MicroPython - [hackster.io](https://www.hackster.io/shaoziyang/lcd1602-bigfont-number-300551).

[![A fleet of obstacle avoiding MicroPython RP2040 robots](../assets/20260622/20260622bot.jpg)](https://www.youtube.com/watch?v=SbfEfmMHzzE)

A fleet of obstacle avoiding robots using MicroPython on RP2040 boards - [YouTube](https://www.youtube.com/watch?v=SbfEfmMHzzE).

[![Pico Commander](../assets/20260622/20260622cmdr.jpg)](https://www.hackster.io/makepkg/pico-commander-a-15-automation-tool-for-headless-servers-d6d6ed)

Pico Commander is a $15 open-source macro pad built on the Raspberry Pi Pico running CircuitPython. It requires zero drivers (acts as a standard USB HID Keyboard) and is configured entirely through a visual offline web editor - [hackster.io](https://www.hackster.io/makepkg/pico-commander-a-15-automation-tool-for-headless-servers-d6d6ed).

[![Raspberry Pi tutorial - Pulse Width Modulation (PWM)](../assets/20260622/20260622sim.jpg)](https://www.youtube.com/watch?v=Ds4uM0Ya4nM)

A Raspberry Pi tutorial on Pulse Width Modulation (PWM) with MicroPython - [YouTube](https://www.youtube.com/watch?v=Ds4uM0Ya4nM).

[![Macropad With Digital Stereo Audio Using Pimoroni Keybow 2040 and MAX98357A Audio Board (HID + MIDI Capable)](../assets/20260622/20260622key.jpg)](https://www.instructables.com/Keybow-2040-I2S-Stereo-Speakers-Macropad-Addition/)

Macropad With digital stereo audio Using Pimoroni Keybow 2040 and MAX98357A audio board (HID + MIDI Capable) - [Instructables](https://www.instructables.com/Keybow-2040-I2S-Stereo-Speakers-Macropad-Addition/).

[![Computer Vision and Projection Mapping in Python](../assets/20260622/20260622sf.jpg)](https://www.digikey.com/en/maker/tutorials/2026/computer-vision-and-projection-mapping-in-python)

Computer vision and projection mapping in Python on Raspberry Pi - [DigiKey](https://www.digikey.com/en/maker/tutorials/2026/computer-vision-and-projection-mapping-in-python).

[![Interactive Musical Board](../assets/20260622/20260622buttons.jpg)](https://www.instructables.com/Interactive-Musical-Board)

The Interactive Musical Game Board is an assistive technology device running CircuitPython designed for students with physical and cognitive disabilities at the Campus School to enjoy music by pressing buttons. The board features 9 100mm arcade buttons (8 blue and 1 red) each triggering colorful NeoPixel LED light feedback and cheerful audio playback through a speaker when pressed - [Instructables](https://www.instructables.com/Interactive-Musical-Board).

[![Smart Beehive Winter Monitor](../assets/20260622/20260622bee.jpg)](https://www.instructables.com/Smart-Beehive-Winter-Monitor)

The Smart Beehive Winter Monitor is a CircuitPython sensor pod that watches the inside of a beehive and alerts the beekeeper hours before condensation forms. It runs on an ESP32-S3 Feather, sleeps between readings, publishes to a free Adafruit IO dashboard over WiFi, and computes the dew-point spread, the leading indicator that humidity alone can't show - [Instructables](https://www.instructables.com/Smart-Beehive-Winter-Monitor).

[![Everything Security at PyCon US 2026](../assets/20260622/20260622sec.jpg)](https://pyfound.blogspot.com/2026/06/everything-security-at-pycon-us-2026.html)

Everything Security that was presented at PyCon US 2026 - [Python Software Foundation Blog](https://pyfound.blogspot.com/2026/06/everything-security-at-pycon-us-2026.html).

[![𝗖𝗿𝗮𝗻𝗸𝗚𝗣𝗧](../assets/20260622/20260622crank.jpg)](https://x.com/GenAISpotlight/status/2067987524945948760)

CrankGPT runs AI on a hand crank, no battery needed. Europe-based Squeez Labs built it around a Raspberry Pi 5 and a 20W hand-crank generator - [X](https://x.com/GenAISpotlight/status/2067987524945948760).
...
[20260619](https://github.com/adafruit/Adafruit_CircuitPython_Bundle/releases/latest) is the latest Adafruit CircuitPython library bundle.
...
[4,519 Stars](https://github.com/adafruit/circuitpython/stargazers) Like CircuitPython? [Star it on GitHub!](https://github.com/adafruit/circuitpython)
...
[![38,946 THANKS](../assets/20260622/39kdiscord.jpg)](https://adafru.it/discord)
