...
Frederick Blais has created CircuitPython MCP Server, minimal MCP JSON-RPC server helpers for CircuitPython projects using `adafruit_httpserver` - [GitHub](https://github.com/speccy88/circuitpython-mcp-server).
