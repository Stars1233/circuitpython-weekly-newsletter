---
layout: post
title: "Raspberry Pi CM0 Modules in Products, New CircuitPython, A New Arduino and More!"
...
Welcome to the latest hand-crafted Python on Microcontrollers newsletter! In an age of AI hallucination content, here is a very human curated selection of information & news folks using Python on hardware can trust. This week, another bug fix version of CircuitPython is out. The elusive Raspberry Pi CM0 module finally is out of China in products, and Roby is sinking in popularity, swamped by Python. All this and more plus some nice projects like a professional-grade ISS tracker and more. - *Anne Barela, Editor*
...
[![Jumperless V5](../assets/20260316/20260316jless.jpg)](https://docs.jumperless.org/09.5-micropythonAPIreference/)

The [Jumperless V5](https://www.crowdsupply.com/architeuthis-flux/jumperless-v5) breadboard now has an API and IDE for using MicroPython. The [development environment](https://ide.jumperless.org/) (IDE) is a fork of ViperIDE - [MicroPython API Reference for Jumper V5](https://docs.jumperless.org/09.5-micropythonAPIreference/). Via [BlueSky](https://bsky.app/profile/architeuthisflux.bsky.social/post/3mfkgqbdn7s2u).

[![Rovari Circuit Studio: CircuitPython debugger support](../assets/20260316/20260316debug.jpg)](https://www.youtube.com/watch?v=Ex16vmKtpKY)

Rovari Circuit Studio: CircuitPython debugger support has just been added - [YouTube](https://www.youtube.com/watch?v=Ex16vmKtpKY).
...
[![Learn Guides](../assets/20260316/20260316learn.jpg)](https://learn.adafruit.com/guides/latest)
