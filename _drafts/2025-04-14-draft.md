...
Welcome to the latest Python on Microcontrollers newsletter! Who said "May we live in interesting times?" This week was truly interesting in many ways. Tariff effects are rippling through the global economy. Adafruit's Ladyada and Phil go over this and how it relates to maker business. In other news, MicroPython's port to Alif microcontrollers is a hot rod capable of real-time image recognition. And **six** versions of Python were released. Where are each in their lifecycle? That's discussed too. Some fabulous projects and more this week, I hope you like it. - *Anne Barela, Editor*
