...
Nick Hodges in InfoWorld wrote an artticle by that name. Up until a few months ago, most Pythoon folks used Markdown text as a way to format README and LICENSE files in their code repositories. Now X/Twitter feeds are clogged with posts that start with "🚨 BREAKING: Someone just open-sourced a tool that ...". They typically lead to a set of Markdown files for instructing an AI, moost often Claude, to learn new skills. And the wave is not about to crest anytime soon. And when one asks Claude Cowork to do some data crunching, it often codes in Python. And when you save the project to use it again, it'll remember via a Markdown file. Python and Markdown were just thrown in the fast lane. And folks are keeping an eye out - [InfoWorld](https://www.infoworld.com/article/4146579/markdown-is-now-a-first-class-coding-language-deal-with-it.html).
...
[![title](../assets/20260323/20260323new2.jpg)](url)
