---
layout: post
title: "AI Helping Your Development While Arduino T&Cs Grow Onerous and More!"
...
Welcome to the latest Python on Microcontrollers newsletter! The last issue was rather traditional in respect to the news. This week there is a bounty of content where Python intersects AI and LLMs. Not in an evil "AI will write all code" but in a benevolent "LLMs can help you do things better" approach. Examples: GitHub scans to ensure your private `secrets.txt` or `settings.toml` are not uploaded. Or connecting your oscilloscope to your computer so Claude Code can see I2C timings in MicroPython. Or having AI review your project and help with the documentation. You're still in the loop, AI is helping. Beyond all that is the usual cornucopia of Python/MicroPython/CircuitPython goodness you have come to expect each week, hand curated for your situational awareness. - *Anne Barela, Editor*
...
SparkFun adds beta documentation AI integration and updated organization. CircuitPython and MicroPython show up approximately 17,500 times each in a search - [SparkFun News](https://news.sparkfun.com/15948). Via [X](https://x.com/sparkfun/status/2034359685764014228).
...
- [Yoto Player V3 by Yoto Limited](https://circuitpython.org/board/yoto_player_v3/)
- [Yoto Mini (2024 Edition) by Yoto Limited](https://circuitpython.org/board/yoto_mini_2024/)
- [Nucleo N657X0-Q by STMicroelectronics](https://circuitpython.org/board/st_nucleo_n657x0_q/)
- [MCXN947 FRDM Development Board by NXP](https://circuitpython.org/board/nxp_mimxrt1170_evk/)
- [MCXN947 FRDM Development Board by NXP](https://circuitpython.org/board/nxp_frdm_mcxn947/)
- [Nordic nRF54H20 Development Kit by Nordic Semiconductor](https://circuitpython.org/board/nordic_nrf54h20dk/)
- [Adafruit TinyChad RP2350](https://circuitpython.org/board/adafruit_tinychad_rp2350/)
...
[![CircuitPython on the Xteink X4 eReader](../assets/20260323/20260323liz.jpg)](https://learn.adafruit.com/circuitpython-on-the-xteink-x4-ereader)

[CircuitPython on the Xteink X4 eReader](https://learn.adafruit.com/circuitpython-on-the-xteink-x4-ereader) from [Liz Clark](https://learn.adafruit.com/u/BlitzCityDIY)
