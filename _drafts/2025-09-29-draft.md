...
The v1.27 release of MicroPython is tentatively scheduled for mid-November, according to Matt Trentini. In the new release, there are 56 boards in the merge queue. Prerelase builds are on their [GitHub](https://github.com/micropython/micropython) - [X](https://x.com/matt_trentini/status/1970625419356569899).
