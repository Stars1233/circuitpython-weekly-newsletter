...
Welcome to the latest Python on Microcontrollers newsletter! Another birthday is in the books for MicroPython tomorrow, and being twelve means it's not an upstart any more. US reetailer SparkFun is jumping more on the MicroPython bandwagon with a new video series and code support. Have you wondered about Claude Code? There is a guide on trying it out. And fresh off last week's free books is a list of free courses from top universities. This and more, as always, in this issue. - *Anne Barela, Editor*
