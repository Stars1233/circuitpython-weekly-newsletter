...
An e-ink weather dashboard with a Raspberry Pi and Python. This low-power weather dashboard displays real-time data from OpenWeatherMap and comes with a web UI to customize and schedule automatic updates - [YouTube](https://www.youtube.com/watch?v=65sda565l9Y) and [GitHub]().
