...
Welcome to the latest Python on Microcontrollers newsletter! It's Summer and folks have settled into a bit of a different routine than during the academic year. It's time to sit back and enjoy reading about the latest in the field. I have a good crop of features covering a broad range of topics in this issue including the results of two summits and how to write good code. Another crop of projects demonstrates folks are taking advantage of their time and the warmth to be very creative. I hope you have a good week. - *Anne Barela, Editor*
...
## Python: The Documentary is Coming (See the Trailer)
